...
data class DatasetOrder(
    ...
    // Lowercase gateway tag ('paymongo' or null) — separate from
    // paymentMethod so reports can split "via PayMongo" buckets from
    // in-person ones even when the customer used the same instrument.
